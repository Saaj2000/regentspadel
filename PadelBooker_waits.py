...
expiry = 
cvv = 
day = "Fri" #choose from Mon, Tue, Wed, Thu, Fri, Sat, Sun
bookingtime= "1400" #set in 24hr hh00 format, denotes start time for booking

driver = webdriver.Chrome(r".\chromedriver.exe") #set location of chromedriver.exe
